...
def gambler(stake, goal, number_of_trails):
    """
    Amount of $money Person has to bet in game
    Desired Price Money by Person
    number_of_trails: Total number of times User can bet in game
    Winning percentage and losing percentage
    """
